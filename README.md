...
|--|-|--|-|
| [1 – Intro to LLMs, RAG & Vector Search](01-intro/) | Foundations | OpenAI API, Elasticsearch, Qdrant, dlt | Build a basic RAG pipeline and index documents using semantic embeddings |
| [2 – Agents](02-agents/) | Agentic RAG | OpenAI Function Calling | Add autonomous tool use and function calling to RAG |
| [3 – AI Orchestration](03-ai-orchestration/) | Orchestration | Kestra | Automate and orchestrate AI workflows with an open-source orchestration platform |
